...
mydb = pymysql.connect(host="localhost",user="root",password="",db="sensor-management")
...
class AddSensor(QDialog):
	...
	def addsensor(self):
		...
		sensor = self.typeSensor.itemText(self.typeSensor.currentIndex())
...
class MainWindow(QMainWindow):
	def __init__(self, *args, **kwargs):
		...
		btn_ac_agent = QAction(QIcon("icon/agent.png"),"Agent",self)   #refresh icon
