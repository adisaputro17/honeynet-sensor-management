            ...
            <div class="card-body">
              ...
              <form action="" method="POST">
                <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="oldpassword" autocomplete="off" required="">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="newpassword1" autocomplete="off" required="">
                </div>

                <button type="submit" class="btn btn-primary" name="btn_changePassword">Submit</button>
              </form>
...
if(isset($_POST['btn_changePassword'])){
  ...
  $query = mysqli_query($koneksi, "select * from admin where password='$oldpassword'");

  if(mysqli_num_rows($query) == 1){

    if($newpassword == $newpassword1){

      mysqli_query($koneksi,"update admin set password='$newpassword'");
